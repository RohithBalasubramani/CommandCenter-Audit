...
import { createConfig, createRunnerConfig } from './config'
import type { AgentConfig, RunnerConfig } from './config'

// ─── Command Center Agent Configuration ──────────────────────────────

export const ccAgentConfig: AgentConfig = createConfig({
...
export const ccRunnerConfig: RunnerConfig = createRunnerConfig({
  agent: ccAgentConfig,
  maxRetries: 1,
  parallelCount: 1,
  browser: 'chromium',
