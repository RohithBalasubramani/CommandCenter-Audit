 ...
 */
export type AgentActionType = 'click' | 'type' | 'navigate' | 'scroll' | 'select' | 'upload' | 'wait' | 'verify' | 'api_call' | 'screenshot' | 'key' | 'hover' | 'drag' | 'done';
...
export interface VerifyAssertion {
    /** What to check */
    check: 'visible' | 'hidden' | 'text_contains' | 'text_equals' | 'count' | 'api_response' | 'page_title' | 'url_contains' | 'url_equals' | 'toast_message' | 'attribute_equals' | 'css_property';
...
export type PersonaModifier = 'default' | 'impatient' | 'confused' | 'power-user' | 'accessibility' | 'mobile' | 'slow-network';
export type QaAgentProfile = 'neurareport' | 'general-purpose';
...
export type FailureCategory = 'element_not_found' | 'element_not_interactable' | 'navigation_error' | 'form_error' | 'timeout' | 'stuck_loop' | 'assertion_failed' | 'browser_crash' | 'llm_error' | 'network_error' | 'auth_error' | 'unknown';
